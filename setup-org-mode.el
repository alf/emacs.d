...
(global-set-key (kbd "C-c k I") 'bh/punch-in)
(global-set-key (kbd "C-c k O") 'bh/punch-out)
(global-set-key (kbd "C-c k a") 'bh/show-org-agenda)
(global-set-key (kbd "C-c k c") 'calendar)
(global-set-key (kbd "C-c k o") 'bh/make-org-scratch)
(global-set-key (kbd "C-c k s") 'bh/switch-to-scratch)
(global-set-key (kbd "C-c k t") 'bh/insert-inactive-timestamp)
(global-set-key (kbd "C-c k T") 'bh/toggle-insert-inactive-timestamp)
(global-set-key (kbd "C-c k SPC") 'bh/clock-in-last-task)
(global-set-key (kbd "C-x n r") 'narrow-to-region)
(global-set-key (kbd "C-c k g") 'org-clock-goto)
               ...
               ((agenda "" nil)
                ...
                (tags-todo "-REFILE-CANCELLED-WAITING/!"
                           ((org-agenda-overriding-header (if (marker-buffer org-agenda-restrict-begin) "Project Subtasks" "Standalone Tasks"))
                            ...
                            (org-agenda-sorting-strategy
                             '(category-keep))))
                (tags-todo "-HOLD-CANCELLED+WAITING/!"
...
(defvar bh/organization-task-id "11F0AFCD-E153-4C75-B812-017523C75220")
